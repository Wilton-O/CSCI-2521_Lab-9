...
/**
 * @brief This function overrides Account's closeOfBusiness
 *        for SavingsAccount, adding daily interest rate calculation
 * @param None.
 * @return None.
 */
...
/**
 * @brief This function overrides Account's printAccountInfo 
 *        for SavingsAccount, adding daily interest rate
 * @param None.
 * @return None.
 */
